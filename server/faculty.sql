...
INSERT INTO Staff (name, title, image_url) VALUES
                                               ('Isaac Newton', 'Professor of Mathematics', 'https://upload.wikimedia.org/wikipedia/commons/3/39/GodfreyKneller-IsaacNewton-1689.jpg'),
                                               ('Rosalind Franklin', 'Lecturer in Molecular Biology', 'https://upload.wikimedia.org/wikipedia/en/6/60/Rosalind_Franklin.jpg'),
                                               ('Charles Darwin', 'Professor of Biology', 'https://upload.wikimedia.org/wikipedia/commons/2/2e/Charles_Darwin_seated_crop.jpg'),
                                               ('Ada Lovelace', 'Lecturer in Mathematics', 'https://upload.wikimedia.org/wikipedia/commons/a/a4/Ada_Lovelace_portrait.jpg');
